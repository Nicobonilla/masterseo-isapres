...
const InformacionIsapresChile = ({ title, description, id_noticia }: IInfoIsapres): ReactNode => {
    return (
        <Link href={`/informacion-isapres-chile/${id_noticia}`}>
...
export { InformacionIsapresChile };
